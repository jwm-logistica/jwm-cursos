<script setup>
   ...
   //mansory layout
   const coursesBoxWidth = process.client ? window.innerWidth - 576 : 870; //size of the client window - (size of the history + gap + page padding)
   ...
   for (let col = 0; col < columns; col++) {
      ...
      coursesMatrix.value.push(actualRows); //push all the rows to the column
   }
</script>
      ...
      <div id="view-body-courses">
         <div class="courses-view">
            ...
            <div id="masonry-layout-courses">
               <div class="masonry-column" v-for="columns in coursesMatrix">
